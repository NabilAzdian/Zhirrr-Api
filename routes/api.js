...
loghandler = {
    notparam: {
        ...
        getApikey: 'need apikey? chat me wa.me/6287772354740'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, need apikey? chat me wa.me/6287772354740'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------NabilAzdian'+'Nabil-AF';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'NabilKey') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'NabilKey') return res.json(loghandler.invalidKey)
